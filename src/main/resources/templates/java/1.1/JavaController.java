...
public class ${table.className}Controller {
	...
	@ResponseBody
	public  Map<String, Object> findListByPage(${table.className} ${table.className?uncap_first}, Page<Map<String, Object>> page, HttpServletRequest request){
	...
	@ResponseBody
	public Map<String, Object> create${table.className}(@RequestBody ${table.className} ${table.className?uncap_first}, HttpServletRequest request) throws Exception{
		Map<String, Object> map = new HashMap<>();
	...
	@ResponseBody
	public Map<String, Object> update${table.className}(@RequestBody ${table.className} ${table.className?uncap_first}, HttpServletRequest request) throws Exception{
		Map<String, Object> map = new HashMap<>();
		map = this.${table.className?uncap_first}Service.update${table.className}(${table.className?uncap_first});
		return map;
	}
	
	@RequestMapping("destroy${table.className}.do")
	@ResponseBody
